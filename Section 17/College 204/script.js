class MessageBoard {
    ...
    */
	...
	/*
        ...
        this.id is and a value of whatever the string is that is passed to the function. 
        The function should return the object created from the class so that the method 
        can be chained. (HINT - to implement the last part, make sure to return this).
    ...
    */
	...
	/*
        ...
        the message in the messages map with the same value as the string passed 
        to the function. If the value is not found in the messages map, the function 
    ...
    */
	...
	findMessageByValue(message) {
		...
		this.messages.forEach(
			val => (val === message ? (temp = val) : undefined)
		);
		return temp;
	}
    ...
    */
	...
	/*
        Add a method called numberOfMessages which returns the number of keys 
        in the messages map
...
/*
    ...
    The function should return the number of unique pairs (two numbers) that sum up 
